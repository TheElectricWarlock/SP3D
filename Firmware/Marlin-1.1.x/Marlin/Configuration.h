...
#define CUSTOM_MACHINE_NAME "SP3D"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //SP3D Heated Bed
  #define  DEFAULT_bedKp 525.41
  #define  DEFAULT_bedKi 101.80
  #define  DEFAULT_bedKd 677.91
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 6000 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 31.35  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 3.250  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0   // Z offset: -below +above  [the nozzle]

// X and Y axis travel speed (mm/m) between probes
#define XY_PROBE_SPEED 2100
